...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    .line 7
    sget-object v0, Landroidx/appcompat/R$styleable;->C2:[I

    const/4 v1, 0x0

    invoke-static {p1, p2, v0, p3, v1}, Landroidx/appcompat/widget/TintTypedArray;->u(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/TintTypedArray;
    ...
    .line 10
    :cond_0
    sget p5, Landroidx/appcompat/R$styleable;->H2:I

    invoke-virtual {v0, p5, v1}, Landroidx/appcompat/widget/TintTypedArray;->m(II)I
    ...
    sget-object v4, Landroidx/appcompat/R$styleable;->C2:[I

    invoke-static {v3, p2, v4, p3, v1}, Landroidx/appcompat/widget/TintTypedArray;->u(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/TintTypedArray;

    move-result-object v1

    .line 22
    sget v3, Landroidx/appcompat/R$styleable;->G2:I

    const/4 v4, -0x2

    invoke-virtual {v1, v3, v4}, Landroidx/appcompat/widget/TintTypedArray;->l(II)I
    ...
    .line 23
    sget v3, Landroidx/appcompat/R$styleable;->E2:I

    .line 24
    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/TintTypedArray;->f(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 26
    sget v3, Landroidx/appcompat/R$styleable;->F2:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/TintTypedArray;->n(I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p4, v3}, Landroidx/appcompat/widget/AppCompatSpinner$DropdownPopup;->c(Ljava/lang/CharSequence;)V

    .line 27
    invoke-virtual {v1}, Landroidx/appcompat/widget/TintTypedArray;->v()V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/TintTypedArray;->n(I)Ljava/lang/String;

    move-result-object v1

    invoke-interface {p4, v1}, Landroidx/appcompat/widget/AppCompatSpinner$SpinnerPopup;->c(Ljava/lang/CharSequence;)V

    .line 32
    :goto_5
    sget p4, Landroidx/appcompat/R$styleable;->D2:I

    invoke-virtual {v0, p4}, Landroidx/appcompat/widget/TintTypedArray;->p(I)[Ljava/lang/CharSequence;
    ...
    .line 41
    :cond_8
    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->f:Landroidx/appcompat/widget/AppCompatBackgroundHelper;

    invoke-virtual {p0, p2, p3}, Landroidx/appcompat/widget/AppCompatBackgroundHelper;->e(Landroid/util/AttributeSet;I)V
...
.method b()V
    ...
    invoke-interface {v0, v1, p0}, Landroidx/appcompat/widget/AppCompatSpinner$SpinnerPopup;->g(II)V
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$SpinnerPopup;->a()I
...
.method final getInternalPopup()Landroidx/appcompat/widget/AppCompatSpinner$SpinnerPopup;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->k:Landroidx/appcompat/widget/AppCompatSpinner$SpinnerPopup;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$SpinnerPopup;->i()Ljava/lang/CharSequence;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-interface {p0, v1}, Landroidx/appcompat/widget/AppCompatSpinner$SpinnerPopup;->j(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {p0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$SpinnerPopup;->f(I)V
