...
.method private B(IF)V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatTextHelper;->i:Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;

    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->u(IF)V
...
.method private C(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    invoke-virtual {p2, v0, v1}, Landroidx/appcompat/widget/TintTypedArray;->j(II)I
    ...
    :cond_0
    sget v0, Landroidx/appcompat/R$styleable;->e3:I

    invoke-virtual {p2, v0}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z
    ...
    invoke-virtual {p2, v3}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z
    ...
    invoke-virtual {p2, p1, v4}, Landroidx/appcompat/widget/TintTypedArray;->j(II)I
    ...
    invoke-virtual {p2, v0, p1, v7}, Landroidx/appcompat/widget/TintTypedArray;->i(IILandroidx/core/content/res/ResourcesCompat$FontCallback;)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p2, v0}, Landroidx/appcompat/widget/TintTypedArray;->n(I)Ljava/lang/String;
...
.method private a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V
    ...
    invoke-static {p1, p2, p0}, Landroidx/appcompat/widget/AppCompatDrawableManager;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;[I)V
...
.method e()I
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->g()I
...
.method f()I
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->h()I
...
.method g()I
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->i()I
...
.method h()[I
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->j()[I
...
.method i()I
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->k()I
...
.method m(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v10, v8, v2, v9, v12}, Landroidx/appcompat/widget/TintTypedArray;->u(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/TintTypedArray;
    ...
    invoke-virtual {v13}, Landroidx/appcompat/widget/TintTypedArray;->q()Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v13, v0, v14}, Landroidx/appcompat/widget/TintTypedArray;->m(II)I

    move-result v0

    sget v1, Landroidx/appcompat/R$styleable;->g0:I

    invoke-virtual {v13, v1}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v13, v1, v12}, Landroidx/appcompat/widget/TintTypedArray;->m(II)I
    ...
    :cond_5
    invoke-virtual {v13}, Landroidx/appcompat/widget/TintTypedArray;->v()V
    ...
    sget-object v3, Landroidx/appcompat/R$styleable;->Z2:[I

    invoke-static {v10, v0, v3}, Landroidx/appcompat/widget/TintTypedArray;->s(Landroid/content/Context;I[I)Landroidx/appcompat/widget/TintTypedArray;
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z
    ...
    sget v5, Landroidx/appcompat/R$styleable;->j3:I

    invoke-virtual {v0, v5}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z

    move-result v6

    if-eqz v6, :cond_7

    invoke-virtual {v0, v5}, Landroidx/appcompat/widget/TintTypedArray;->n(I)Ljava/lang/String;
    ...
    :goto_1
    sget v6, Landroidx/appcompat/R$styleable;->h3:I

    invoke-virtual {v0, v6}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z

    move-result v15

    if-eqz v15, :cond_8

    invoke-virtual {v0, v6}, Landroidx/appcompat/widget/TintTypedArray;->n(I)Ljava/lang/String;
    ...
    invoke-static {v10, v8, v0, v9, v12}, Landroidx/appcompat/widget/TintTypedArray;->u(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/TintTypedArray;

    move-result-object v0

    if-nez v1, :cond_a

    sget v15, Landroidx/appcompat/R$styleable;->i3:I

    invoke-virtual {v0, v15}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z

    move-result v15

    if-eqz v15, :cond_b

    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/TintTypedArray;->n(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v4, v14}, Landroidx/appcompat/widget/TintTypedArray;->e(II)I
    ...
    invoke-static {v10, v8, v0}, Landroidx/appcompat/widget/TintTypedArray;->t(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/TintTypedArray;

    move-result-object v8

    sget v0, Landroidx/appcompat/R$styleable;->s0:I

    invoke-virtual {v8, v0, v14}, Landroidx/appcompat/widget/TintTypedArray;->m(II)I
    ...
    invoke-virtual {v8, v0}, Landroidx/appcompat/widget/TintTypedArray;->r(I)Z
    ...
    invoke-static {v1, v0}, Landroidx/core/widget/TextViewCompat;->e(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v8, v0, v14}, Landroidx/appcompat/widget/TintTypedArray;->j(II)I

    move-result v0

    invoke-static {v0, v13}, Landroidx/appcompat/widget/DrawableUtils;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iget-object v1, v7, Landroidx/appcompat/widget/AppCompatTextHelper;->a:Landroid/widget/TextView;

    invoke-static {v1, v0}, Landroidx/core/widget/TextViewCompat;->f(Landroid/widget/TextView;Landroid/graphics/PorterDuff$Mode;)V

    :cond_1c
    sget v0, Landroidx/appcompat/R$styleable;->y0:I

    invoke-virtual {v8, v0, v14}, Landroidx/appcompat/widget/TintTypedArray;->e(II)I

    move-result v0

    sget v1, Landroidx/appcompat/R$styleable;->z0:I

    invoke-virtual {v8, v1, v14}, Landroidx/appcompat/widget/TintTypedArray;->e(II)I

    move-result v1

    sget v2, Landroidx/appcompat/R$styleable;->A0:I

    invoke-virtual {v8, v2, v14}, Landroidx/appcompat/widget/TintTypedArray;->e(II)I

    move-result v2

    invoke-virtual {v8}, Landroidx/appcompat/widget/TintTypedArray;->v()V

    if-eq v0, v14, :cond_1d

    iget-object v3, v7, Landroidx/appcompat/widget/AppCompatTextHelper;->a:Landroid/widget/TextView;

    invoke-static {v3, v0}, Landroidx/core/widget/TextViewCompat;->g(Landroid/widget/TextView;I)V
    ...
    invoke-static {v0, v2}, Landroidx/core/widget/TextViewCompat;->i(Landroid/widget/TextView;I)V
...
.method q(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p2, v0}, Landroidx/appcompat/widget/TintTypedArray;->s(Landroid/content/Context;I[I)Landroidx/appcompat/widget/TintTypedArray;
    ...
    invoke-virtual {p2, v0, v1}, Landroidx/appcompat/widget/TintTypedArray;->e(II)I
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/widget/TintTypedArray;->n(I)Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p2}, Landroidx/appcompat/widget/TintTypedArray;->v()V
...
.method r(Landroid/widget/TextView;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-static {p3, p0}, Landroidx/core/view/inputmethod/EditorInfoCompat;->e(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;)V
...
.method t(IIII)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->q(IIII)V
...
.method u([II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->r([II)V
...
.method v(I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->s(I)V
