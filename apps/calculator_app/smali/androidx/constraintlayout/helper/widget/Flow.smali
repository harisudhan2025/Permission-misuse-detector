...
# instance fields
.field private q:Landroidx/constraintlayout/core/widgets/Flow;
...
.method protected o(Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/constraintlayout/helper/widget/Flow;->q:Landroidx/constraintlayout/core/widgets/Flow;
    ...
    iget-object v4, p0, Landroidx/constraintlayout/helper/widget/Flow;->q:Landroidx/constraintlayout/core/widgets/Flow;
    ...
    :cond_7
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->o2:I
    ...
    :cond_8
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->e2:I
    ...
    :cond_9
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->n2:I
    ...
    :cond_b
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->g2:I
    ...
    :cond_c
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->a2:I
    ...
    :cond_d
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->i2:I
    ...
    :cond_e
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->c2:I
    ...
    :cond_10
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->f2:I
    ...
    :cond_12
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->h2:I
    ...
    :cond_13
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->l2:I
    ...
    :cond_14
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->b2:I
    ...
    :cond_15
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->k2:I
    ...
    :cond_16
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->d2:I
    ...
    :cond_17
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->m2:I
    ...
    :cond_18
    sget v4, Landroidx/constraintlayout/widget/R$styleable;->j2:I
    ...
    :cond_1b
    iget-object p1, p0, Landroidx/constraintlayout/helper/widget/Flow;->q:Landroidx/constraintlayout/core/widgets/Flow;

    iput-object p1, p0, Landroidx/constraintlayout/widget/ConstraintHelper;->i:Landroidx/constraintlayout/core/widgets/Helper;
...
.method protected onMeasure(II)V
    ...
    iget-object v0, p0, Landroidx/constraintlayout/helper/widget/Flow;->q:Landroidx/constraintlayout/core/widgets/Flow;
...
.method public p(Landroidx/constraintlayout/widget/ConstraintSet$Constraint;Landroidx/constraintlayout/core/widgets/HelperWidget;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;)V
    ...
    iget p0, p3, Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;->Z:I

    const/4 p1, -0x1

    if-eq p0, p1, :cond_0

    invoke-virtual {p2, p0}, Landroidx/constraintlayout/core/widgets/Flow;->H2(I)V
...
.method public q(Landroidx/constraintlayout/core/widgets/ConstraintWidget;Z)V
    ...
    iget-object p0, p0, Landroidx/constraintlayout/helper/widget/Flow;->q:Landroidx/constraintlayout/core/widgets/Flow;

    invoke-virtual {p0, p2}, Landroidx/constraintlayout/core/widgets/VirtualLayout;->x1(Z)V
