...
.method private l(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    sget-object v0, Landroidx/constraintlayout/widget/R$styleable;->Qb:[I
    ...
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->Rb:I
    ...
    :cond_0
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->Zb:I
    ...
    sget-boolean v2, Landroidx/constraintlayout/motion/widget/MotionLayout;->i1:Z
    ...
    :cond_3
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->ac:I
    ...
    :cond_4
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->dc:I
    ...
    :cond_5
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->bc:I
    ...
    :cond_6
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->Vb:I
    ...
    :cond_7
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->ec:I
    ...
    :cond_8
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->fc:I
    ...
    :cond_9
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->Yb:I
    ...
    :cond_d
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->cc:I
    ...
    :cond_e
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->Ub:I
    ...
    :cond_f
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->Xb:I
    ...
    :cond_10
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->Wb:I
    ...
    :cond_11
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->Tb:I
    ...
    :cond_12
    sget v2, Landroidx/constraintlayout/widget/R$styleable;->Sb:I
...
.method private n(Landroidx/constraintlayout/motion/widget/MotionScene$Transition;Landroid/view/View;)V
    ...
    iget-object p0, p0, Landroidx/constraintlayout/motion/widget/ViewTransition;->f:Landroidx/constraintlayout/motion/widget/KeyFrames;

    if-eqz p0, :cond_2

    invoke-virtual {p0, v1}, Landroidx/constraintlayout/motion/widget/KeyFrames;->d(I)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1}, Landroidx/constraintlayout/motion/widget/Key;->b()Landroidx/constraintlayout/motion/widget/Key;

    move-result-object v1

    invoke-virtual {v1, p2}, Landroidx/constraintlayout/motion/widget/Key;->i(I)Landroidx/constraintlayout/motion/widget/Key;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroidx/constraintlayout/motion/widget/KeyFrames;->c(Landroidx/constraintlayout/motion/widget/Key;)V

    goto :goto_0

    :cond_1
    invoke-virtual {p1, v0}, Landroidx/constraintlayout/motion/widget/MotionScene$Transition;->t(Landroidx/constraintlayout/motion/widget/KeyFrames;)V
...
.method varargs c(Landroidx/constraintlayout/motion/widget/ViewTransitionController;Landroidx/constraintlayout/motion/widget/MotionLayout;ILandroidx/constraintlayout/widget/ConstraintSet;[Landroid/view/View;)V
    ...
    :cond_2
    invoke-virtual {p2, v1}, Landroidx/constraintlayout/motion/widget/MotionLayout;->o0(I)Landroidx/constraintlayout/widget/ConstraintSet;
    ...
    invoke-virtual {p1, p4}, Landroidx/constraintlayout/widget/ConstraintSet;->r(Landroidx/constraintlayout/widget/ConstraintSet;)V
    ...
    :cond_7
    invoke-virtual {p2, p3, p1}, Landroidx/constraintlayout/motion/widget/MotionLayout;->N0(ILandroidx/constraintlayout/widget/ConstraintSet;)V

    sget p1, Landroidx/constraintlayout/widget/R$id;->b:I

    invoke-virtual {p2, p1, p4}, Landroidx/constraintlayout/motion/widget/MotionLayout;->N0(ILandroidx/constraintlayout/widget/ConstraintSet;)V

    const/4 p4, -0x1

    invoke-virtual {p2, p1, p4, p4}, Landroidx/constraintlayout/motion/widget/MotionLayout;->A0(III)V

    new-instance v0, Landroidx/constraintlayout/motion/widget/MotionScene$Transition;

    iget-object v1, p2, Landroidx/constraintlayout/motion/widget/MotionLayout;->E:Landroidx/constraintlayout/motion/widget/MotionScene;
...
.method f(Landroid/content/Context;)Landroid/view/animation/Interpolator;
    ...
    :cond_7
    iget p0, p0, Landroidx/constraintlayout/motion/widget/ViewTransition;->n:I
...
.method public g()I
    ...
    iget p0, p0, Landroidx/constraintlayout/motion/widget/ViewTransition;->t:I
...
.method public h()I
    ...
    iget p0, p0, Landroidx/constraintlayout/motion/widget/ViewTransition;->u:I
...
.method public i()I
    ...
    iget p0, p0, Landroidx/constraintlayout/motion/widget/ViewTransition;->b:I
