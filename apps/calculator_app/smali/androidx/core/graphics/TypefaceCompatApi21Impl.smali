...
.method public b(Landroid/content/Context;Landroidx/core/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {v1}, Landroidx/core/content/res/FontResourcesParserCompat$FontFileResourceEntry;->b()I

    move-result v4

    invoke-static {v2, p3, v4}, Landroidx/core/graphics/TypefaceCompatUtil;->c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    invoke-virtual {v1}, Landroidx/core/content/res/FontResourcesParserCompat$FontFileResourceEntry;->e()I

    move-result v5

    invoke-virtual {v1}, Landroidx/core/content/res/FontResourcesParserCompat$FontFileResourceEntry;->f()Z

    move-result v1

    invoke-static {p0, v4, v5, v1}, Landroidx/core/graphics/TypefaceCompatApi21Impl;->j(Ljava/lang/Object;Ljava/lang/String;IZ)Z
    ...
    :cond_3
    invoke-static {p0}, Landroidx/core/graphics/TypefaceCompatApi21Impl;->k(Ljava/lang/Object;)Landroid/graphics/Typeface;
