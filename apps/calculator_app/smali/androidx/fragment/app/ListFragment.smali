...
.field private final i0:Landroid/widget/AdapterView$OnItemClickListener;

.field j0:Landroid/widget/ListAdapter;
...
.field p0:Ljava/lang/CharSequence;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/fragment/app/ListFragment;->g0:Landroid/os/Handler;
    ...
    iput-object v0, p0, Landroidx/fragment/app/ListFragment;->h0:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroidx/fragment/app/ListFragment;->i0:Landroid/widget/AdapterView$OnItemClickListener;
...
.method private i3()V
    ...
    iget-object v0, p0, Landroidx/fragment/app/ListFragment;->k0:Landroid/widget/ListView;
    ...
    iput-object v0, p0, Landroidx/fragment/app/ListFragment;->k0:Landroid/widget/ListView;
    ...
    iput-object v1, p0, Landroidx/fragment/app/ListFragment;->m0:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Landroidx/fragment/app/ListFragment;->l0:Landroid/view/View;
    ...
    iget-object v1, p0, Landroidx/fragment/app/ListFragment;->l0:Landroid/view/View;
    ...
    :cond_5
    iget-object v0, p0, Landroidx/fragment/app/ListFragment;->p0:Ljava/lang/CharSequence;

    if-eqz v0, :cond_6

    iget-object v1, p0, Landroidx/fragment/app/ListFragment;->m0:Landroid/widget/TextView;
    ...
    iput-boolean v0, p0, Landroidx/fragment/app/ListFragment;->q0:Z

    iget-object v0, p0, Landroidx/fragment/app/ListFragment;->k0:Landroid/widget/ListView;

    iget-object v1, p0, Landroidx/fragment/app/ListFragment;->i0:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v0, v1}, Landroid/widget/AdapterView;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroidx/fragment/app/ListFragment;->j0:Landroid/widget/ListAdapter;

    if-eqz v0, :cond_7

    const/4 v1, 0x0

    iput-object v1, p0, Landroidx/fragment/app/ListFragment;->j0:Landroid/widget/ListAdapter;

    invoke-virtual {p0, v0}, Landroidx/fragment/app/ListFragment;->k3(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {p0, v0, v0}, Landroidx/fragment/app/ListFragment;->l3(ZZ)V

    :cond_8
    :goto_2
    iget-object v0, p0, Landroidx/fragment/app/ListFragment;->g0:Landroid/os/Handler;

    iget-object p0, p0, Landroidx/fragment/app/ListFragment;->h0:Ljava/lang/Runnable;
...
.method private l3(ZZ)V
    .locals 5

    invoke-direct {p0}, Landroidx/fragment/app/ListFragment;->i3()V

    iget-object v0, p0, Landroidx/fragment/app/ListFragment;->n0:Landroid/view/View;

    if-eqz v0, :cond_4

    iget-boolean v1, p0, Landroidx/fragment/app/ListFragment;->q0:Z
    ...
    :cond_0
    iput-boolean p1, p0, Landroidx/fragment/app/ListFragment;->q0:Z
    ...
    iget-object p0, p0, Landroidx/fragment/app/ListFragment;->o0:Landroid/view/View;
...
.method public N1()V
    ...
    iget-object v1, p0, Landroidx/fragment/app/ListFragment;->h0:Ljava/lang/Runnable;
    ...
    iput-boolean v1, p0, Landroidx/fragment/app/ListFragment;->q0:Z
    ...
    iput-object v0, p0, Landroidx/fragment/app/ListFragment;->l0:Landroid/view/View;

    iput-object v0, p0, Landroidx/fragment/app/ListFragment;->m0:Landroid/widget/TextView;
...
.method public j3(Landroid/widget/ListView;Landroid/view/View;IJ)V
    .locals 0

    return-void
.end method

.method public k3(Landroid/widget/ListAdapter;)V
    .locals 4
    ...
    :goto_0
    iput-object p1, p0, Landroidx/fragment/app/ListFragment;->j0:Landroid/widget/ListAdapter;

    iget-object v3, p0, Landroidx/fragment/app/ListFragment;->k0:Landroid/widget/ListView;

    if-eqz v3, :cond_2

    invoke-virtual {v3, p1}, Landroid/widget/ListView;->setAdapter(Landroid/widget/ListAdapter;)V

    iget-boolean p1, p0, Landroidx/fragment/app/ListFragment;->q0:Z
    ...
    :cond_1
    invoke-direct {p0, v2, v1}, Landroidx/fragment/app/ListFragment;->l3(ZZ)V
