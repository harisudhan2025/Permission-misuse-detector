...
.method private constructor <init>(Landroidx/lifecycle/LifecycleOwner;Z)V
    ...
    .line 9
    sget-object p1, Landroidx/lifecycle/Lifecycle$State;->g:Landroidx/lifecycle/Lifecycle$State;
...
.method private d(Landroidx/lifecycle/LifecycleOwner;)V
    ...
    invoke-virtual {v0}, Landroidx/arch/core/internal/SafeIterableMap;->a()Ljava/util/Iterator;
...
.method private e(Landroidx/lifecycle/LifecycleObserver;)Landroidx/lifecycle/Lifecycle$State;
    ...
    invoke-virtual {v0, p1}, Landroidx/arch/core/internal/FastSafeIterableMap;->i(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    :cond_1
    iget-object p0, p0, Landroidx/lifecycle/LifecycleRegistry;->c:Landroidx/lifecycle/Lifecycle$State;

    invoke-static {p0, p1}, Landroidx/lifecycle/LifecycleRegistry;->k(Landroidx/lifecycle/Lifecycle$State;Landroidx/lifecycle/Lifecycle$State;)Landroidx/lifecycle/Lifecycle$State;

    move-result-object p0

    invoke-static {p0, v0}, Landroidx/lifecycle/LifecycleRegistry;->k(Landroidx/lifecycle/Lifecycle$State;Landroidx/lifecycle/Lifecycle$State;)Landroidx/lifecycle/Lifecycle$State;
...
.method private f(Ljava/lang/String;)V
    ...
    iget-boolean p0, p0, Landroidx/lifecycle/LifecycleRegistry;->i:Z

    if-eqz p0, :cond_1

    invoke-static {}, Landroidx/arch/core/executor/ArchTaskExecutor;->d()Landroidx/arch/core/executor/ArchTaskExecutor;

    move-result-object p0

    invoke-virtual {p0}, Landroidx/arch/core/executor/ArchTaskExecutor;->b()Z
...
.method private i()Z
    ...
    invoke-virtual {v2}, Landroidx/arch/core/internal/SafeIterableMap;->e()Ljava/util/Map$Entry;
...
.method private m()V
    ...
    iget-object p0, p0, Landroidx/lifecycle/LifecycleRegistry;->h:Ljava/util/ArrayList;
...
.method private p()V
    ...
    invoke-virtual {v2}, Landroidx/arch/core/internal/SafeIterableMap;->b()Ljava/util/Map$Entry;
    ...
    invoke-virtual {v1}, Landroidx/arch/core/internal/SafeIterableMap;->e()Ljava/util/Map$Entry;
...
.method public a(Landroidx/lifecycle/LifecycleObserver;)V
    ...
    invoke-virtual {v1, p1, v0}, Landroidx/arch/core/internal/FastSafeIterableMap;->g(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public c(Landroidx/lifecycle/LifecycleObserver;)V
    ...
    iget-object p0, p0, Landroidx/lifecycle/LifecycleRegistry;->b:Landroidx/arch/core/internal/FastSafeIterableMap;

    invoke-virtual {p0, p1}, Landroidx/arch/core/internal/FastSafeIterableMap;->h(Ljava/lang/Object;)Ljava/lang/Object;
