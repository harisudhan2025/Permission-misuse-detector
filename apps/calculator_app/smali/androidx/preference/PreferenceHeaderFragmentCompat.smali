...
# instance fields
.field private g0:Landroidx/activity/OnBackPressedCallback;
...
.method public static synthetic i3(Landroidx/preference/PreferenceHeaderFragmentCompat;)V
    .locals 0

    invoke-static {p0}, Landroidx/preference/PreferenceHeaderFragmentCompat;->o3(Landroidx/preference/PreferenceHeaderFragmentCompat;)V

    return-void
.end method

.method public static final synthetic j3(Landroidx/preference/PreferenceHeaderFragmentCompat;)Landroidx/activity/OnBackPressedCallback;
    .locals 0

    iget-object p0, p0, Landroidx/preference/PreferenceHeaderFragmentCompat;->g0:Landroidx/activity/OnBackPressedCallback;

    return-object p0
.end method

.method private final k3(Landroid/view/LayoutInflater;)Landroidx/slidingpanelayout/widget/SlidingPaneLayout;
    .locals 6
    ...
    sget v1, Landroidx/preference/R$id;->d:I
    ...
    sget v2, Landroidx/preference/R$id;->c:I
    ...
    sget v4, Landroidx/preference/R$dimen;->b:I
    ...
    sget v5, Landroidx/preference/R$integer;->b:I
    ...
    sget p1, Landroidx/preference/R$id;->b:I
    ...
    sget v3, Landroidx/preference/R$dimen;->a:I
    ...
    sget v2, Landroidx/preference/R$integer;->a:I
    ...
    iput p0, p1, Landroidx/slidingpanelayout/widget/SlidingPaneLayout$LayoutParams;->a:F
...
.method private static final o3(Landroidx/preference/PreferenceHeaderFragmentCompat;)V
    .locals 1
    ...
    iget-object v0, p0, Landroidx/preference/PreferenceHeaderFragmentCompat;->g0:Landroidx/activity/OnBackPressedCallback;
...
.method private final p3(Landroid/content/Intent;)V
    .locals 0
...
.method private final q3(Landroidx/preference/Preference;)V
    .locals 3
    ...
    invoke-direct {p0, p1}, Landroidx/preference/PreferenceHeaderFragmentCompat;->p3(Landroid/content/Intent;)V
    ...
    invoke-virtual {v1}, Landroidx/fragment/app/FragmentManager;->t0()Landroidx/fragment/app/FragmentFactory;
    ...
    invoke-virtual {v0, p1}, Landroidx/fragment/app/Fragment;->P2(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1, v2}, Landroidx/fragment/app/FragmentManager;->n0(I)Landroidx/fragment/app/FragmentManager$BackStackEntry;
    ...
    invoke-interface {p1}, Landroidx/fragment/app/FragmentManager$BackStackEntry;->a()I
    ...
    invoke-virtual {p1, v1}, Landroidx/fragment/app/FragmentTransaction;->w(Z)Landroidx/fragment/app/FragmentTransaction;

    sget v1, Landroidx/preference/R$id;->b:I
    ...
    invoke-virtual {p0}, Landroidx/preference/PreferenceHeaderFragmentCompat;->l3()Landroidx/slidingpanelayout/widget/SlidingPaneLayout;
...
.method public B(Landroidx/preference/PreferenceFragmentCompat;Landroidx/preference/Preference;)Z
    ...
    sget v1, Landroidx/preference/R$id;->c:I

    const/4 v2, 0x1

    if-ne v0, v1, :cond_0

    invoke-direct {p0, p2}, Landroidx/preference/PreferenceHeaderFragmentCompat;->q3(Landroidx/preference/Preference;)V
    ...
    sget v0, Landroidx/preference/R$id;->b:I
    ...
    invoke-virtual {p1, p2}, Landroidx/fragment/app/Fragment;->P2(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2}, Landroidx/fragment/app/FragmentTransaction;->w(Z)Landroidx/fragment/app/FragmentTransaction;

    invoke-virtual {p0, v0, p1}, Landroidx/fragment/app/FragmentTransaction;->s(ILandroidx/fragment/app/Fragment;)Landroidx/fragment/app/FragmentTransaction;

    const/16 p1, 0x1003

    invoke-virtual {p0, p1}, Landroidx/fragment/app/FragmentTransaction;->x(I)Landroidx/fragment/app/FragmentTransaction;
...
.method public D1(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/fragment/app/FragmentTransaction;->v(Landroidx/fragment/app/Fragment;)Landroidx/fragment/app/FragmentTransaction;
...
.method public K1(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {p0, p1}, Landroidx/preference/PreferenceHeaderFragmentCompat;->k3(Landroid/view/LayoutInflater;)Landroidx/slidingpanelayout/widget/SlidingPaneLayout;
    ...
    sget p3, Landroidx/preference/R$id;->c:I

    invoke-virtual {p2, p3}, Landroidx/fragment/app/FragmentManager;->i0(I)Landroidx/fragment/app/Fragment;

    move-result-object p2

    if-nez p2, :cond_0

    invoke-virtual {p0}, Landroidx/preference/PreferenceHeaderFragmentCompat;->n3()Landroidx/preference/PreferenceFragmentCompat;
    ...
    invoke-virtual {p0, v0}, Landroidx/fragment/app/FragmentTransaction;->w(Z)Landroidx/fragment/app/FragmentTransaction;

    invoke-virtual {p0, p3, p2}, Landroidx/fragment/app/FragmentTransaction;->c(ILandroidx/fragment/app/Fragment;)Landroidx/fragment/app/FragmentTransaction;
...
.method public e2(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Landroidx/preference/PreferenceHeaderFragmentCompat;->g0:Landroidx/activity/OnBackPressedCallback;
    ...
    invoke-static {p0}, Landroidx/preference/PreferenceHeaderFragmentCompat;->j3(Landroidx/preference/PreferenceHeaderFragmentCompat;)Landroidx/activity/OnBackPressedCallback;
    ...
    invoke-virtual {p1, p2}, Landroidx/fragment/app/FragmentManager;->i(Landroidx/fragment/app/FragmentManager$OnBackStackChangedListener;)V
    ...
    :cond_3
    invoke-interface {p1}, Landroidx/activity/OnBackPressedDispatcherOwner;->h()Landroidx/activity/OnBackPressedDispatcher;

    move-result-object p1

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->j1()Landroidx/lifecycle/LifecycleOwner;
    ...
    invoke-virtual {p1, p2, p0}, Landroidx/activity/OnBackPressedDispatcher;->a(Landroidx/lifecycle/LifecycleOwner;Landroidx/activity/OnBackPressedCallback;)V
...
.method public f2(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Landroidx/preference/PreferenceHeaderFragmentCompat;->m3()Landroidx/fragment/app/Fragment;
...
.method public final l3()Landroidx/slidingpanelayout/widget/SlidingPaneLayout;
    .locals 0
...
.method public m3()Landroidx/fragment/app/Fragment;
    .locals 6
    ...
    invoke-virtual {v0}, Landroidx/preference/PreferenceFragmentCompat;->l3()Landroidx/preference/PreferenceScreen;

    move-result-object v1

    invoke-virtual {v1}, Landroidx/preference/PreferenceGroup;->S0()I
    ...
    invoke-virtual {v5, v3}, Landroidx/preference/PreferenceGroup;->R0(I)Landroidx/preference/Preference;
    ...
    invoke-virtual {v3}, Landroidx/preference/Preference;->p()Ljava/lang/String;
    ...
    invoke-virtual {v1, p0, v0}, Landroidx/fragment/app/FragmentFactory;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Landroidx/fragment/app/Fragment;
...
.method public abstract n3()Landroidx/preference/PreferenceFragmentCompat;
.end method
