...
.method private a(Ljava/util/List;)I
    ...
    iget v2, v2, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->a:I
...
.method private c(Ljava/util/List;ILandroidx/recyclerview/widget/AdapterHelper$UpdateOp;ILandroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    iget p0, p3, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->d:I

    iget v0, p5, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->b:I
    ...
    iget v0, p5, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->d:I
    ...
    iget v2, p5, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->d:I

    add-int/2addr p0, v2

    iput p0, p3, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->d:I

    :cond_3
    add-int/2addr v0, v1

    iput v0, p5, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->b:I
...
.method e(Ljava/util/List;ILandroidx/recyclerview/widget/AdapterHelper$UpdateOp;ILandroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/OpReorderer;->a:Landroidx/recyclerview/widget/OpReorderer$Callback;

    invoke-interface {p0, p5}, Landroidx/recyclerview/widget/OpReorderer$Callback;->a(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-interface {p0, p3}, Landroidx/recyclerview/widget/OpReorderer$Callback;->a(Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;)V
    ...
    iget p0, p3, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->b:I

    iget v0, v6, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->b:I

    if-le p0, v0, :cond_9

    iget v0, v6, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->d:I

    sub-int/2addr p0, v0

    iput p0, p3, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->b:I
    ...
    iget p5, p3, Landroidx/recyclerview/widget/AdapterHelper$UpdateOp;->d:I
