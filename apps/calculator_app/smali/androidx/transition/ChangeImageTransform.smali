...
.method private d0(Landroidx/transition/TransitionValues;)V
    ...
    invoke-static {v0}, Landroidx/transition/ChangeImageTransform;->f0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private static e0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    .locals 5
...
.method private static f0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    :cond_0
    invoke-static {p0}, Landroidx/transition/ChangeImageTransform;->e0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private g0(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    .locals 1

    sget-object p0, Landroidx/transition/ChangeImageTransform;->Q:Landroid/util/Property;
...
.method private h0(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    .locals 2

    sget-object p0, Landroidx/transition/ChangeImageTransform;->Q:Landroid/util/Property;

    sget-object v0, Landroidx/transition/ChangeImageTransform;->P:Landroid/animation/TypeEvaluator;
...
.method public E()[Ljava/lang/String;
    ...
    sget-object p0, Landroidx/transition/ChangeImageTransform;->O:[Ljava/lang/String;
...
.method public g(Landroidx/transition/TransitionValues;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/ChangeImageTransform;->d0(Landroidx/transition/TransitionValues;)V
...
.method public n(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    invoke-direct {p0, p1, p2, v2}, Landroidx/transition/ChangeImageTransform;->g0(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    :cond_9
    :goto_1
    invoke-direct {p0, p1}, Landroidx/transition/ChangeImageTransform;->h0(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
