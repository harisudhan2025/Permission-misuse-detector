...
.method private d0(Landroidx/transition/TransitionValues;)V
    ...
    iget-boolean p0, p0, Landroidx/transition/ChangeTransform;->P:Z
    ...
    invoke-static {v1, p0}, Landroidx/transition/ViewUtils;->j(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    sget v1, Landroidx/transition/R$id;->h:I
...
.method private e0(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V
    .locals 3
    ...
    invoke-virtual {p0, v1}, Landroidx/transition/Transition;->a(Landroidx/transition/Transition$TransitionListener;)Landroidx/transition/Transition;

    sget-boolean p0, Landroidx/transition/ChangeTransform;->U:Z
    ...
    invoke-static {p0, p1}, Landroidx/transition/ViewUtils;->h(Landroid/view/View;F)V

    :cond_2
    const/high16 p0, 0x3f800000    # 1.0f

    invoke-static {v0, p0}, Landroidx/transition/ViewUtils;->h(Landroid/view/View;F)V

    :cond_3
    return-void
.end method

.method private f0(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;Z)Landroid/animation/ObjectAnimator;
    .locals 9
    ...
    invoke-static {v5}, Landroidx/transition/ChangeTransform;->h0(Landroid/view/View;)V
...
.method private g0(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    .locals 3

    invoke-virtual {p0, p1}, Landroidx/transition/Transition;->H(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p2}, Landroidx/transition/Transition;->H(Landroid/view/View;)Z
...
.method static h0(Landroid/view/View;)V
    .locals 9
    ...
    invoke-static/range {v0 .. v8}, Landroidx/transition/ChangeTransform;->j0(Landroid/view/View;FFFFFFFF)V

    return-void
.end method

.method private i0(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V
    .locals 3
    ...
    iget-object p0, p0, Landroidx/transition/ChangeTransform;->Q:Landroid/graphics/Matrix;
...
.method static j0(Landroid/view/View;FFFFFFFF)V
    .locals 0
    ...
    invoke-static {p0, p3}, Landroidx/core/view/ViewCompat;->s0(Landroid/view/View;F)V
...
.method public E()[Ljava/lang/String;
    ...
    sget-object p0, Landroidx/transition/ChangeTransform;->R:[Ljava/lang/String;
...
.method public g(Landroidx/transition/TransitionValues;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/ChangeTransform;->d0(Landroidx/transition/TransitionValues;)V
...
.method public n(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    invoke-direct {p0, v0, v1}, Landroidx/transition/ChangeTransform;->g0(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    invoke-direct {p0, p2, p3}, Landroidx/transition/ChangeTransform;->i0(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V

    :cond_4
    invoke-direct {p0, p2, p3, v1}, Landroidx/transition/ChangeTransform;->f0(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;Z)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/transition/ChangeTransform;->e0(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V
