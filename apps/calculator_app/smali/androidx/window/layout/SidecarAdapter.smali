...
.method public synthetic constructor <init>(Landroidx/window/core/SpecificationComputer$VerificationMode;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 2
    sget-object p1, Landroidx/window/core/SpecificationComputer$VerificationMode;->h:Landroidx/window/core/SpecificationComputer$VerificationMode;
...
.method public final a(Landroidx/window/sidecar/SidecarDeviceState;Landroidx/window/sidecar/SidecarDeviceState;)Z
    ...
    invoke-virtual {v1, p1}, Landroidx/window/layout/SidecarAdapter$Companion;->b(Landroidx/window/sidecar/SidecarDeviceState;)I
...
.method public final g(Landroidx/window/sidecar/SidecarDisplayFeature;Landroidx/window/sidecar/SidecarDeviceState;)Landroidx/window/layout/DisplayFeature;
    ...
    sget-object v1, Landroidx/window/layout/SidecarAdapter$translate$checkedFeature$1;->g:Landroidx/window/layout/SidecarAdapter$translate$checkedFeature$1;

    invoke-virtual {p0, v0, v1}, Landroidx/window/core/SpecificationComputer;->c(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)Landroidx/window/core/SpecificationComputer;

    move-result-object p0

    const-string v0, "Feature bounds must not be 0"

    sget-object v1, Landroidx/window/layout/SidecarAdapter$translate$checkedFeature$2;->g:Landroidx/window/layout/SidecarAdapter$translate$checkedFeature$2;
    ...
    sget-object v1, Landroidx/window/layout/SidecarAdapter$translate$checkedFeature$3;->g:Landroidx/window/layout/SidecarAdapter$translate$checkedFeature$3;
    ...
    sget-object v1, Landroidx/window/layout/SidecarAdapter$translate$checkedFeature$4;->g:Landroidx/window/layout/SidecarAdapter$translate$checkedFeature$4;
    ...
    :cond_1
    sget-object p0, Landroidx/window/layout/HardwareFoldingFeature$Type;->b:Landroidx/window/layout/HardwareFoldingFeature$Type$Companion;

    invoke-virtual {p0}, Landroidx/window/layout/HardwareFoldingFeature$Type$Companion;->b()Landroidx/window/layout/HardwareFoldingFeature$Type;
    ...
    invoke-virtual {p0}, Landroidx/window/layout/HardwareFoldingFeature$Type$Companion;->a()Landroidx/window/layout/HardwareFoldingFeature$Type;

    move-result-object p0

    :goto_0
    sget-object v3, Landroidx/window/layout/SidecarAdapter;->b:Landroidx/window/layout/SidecarAdapter$Companion;

    invoke-virtual {v3, p2}, Landroidx/window/layout/SidecarAdapter$Companion;->b(Landroidx/window/sidecar/SidecarDeviceState;)I
