...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lcom/miui/support/cardview/CardView;->r:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lcom/miui/support/cardview/CardView;->s:Landroid/graphics/Path;

    sget-object v0, Lcom/miui/support/cardview/R$styleable;->z:[I
    ...
    sget p3, Lcom/miui/support/cardview/R$styleable;->P:I
    ...
    invoke-direct {p0, p1, v2, p3}, Lcom/miui/support/cardview/CardView;->g(Landroid/content/Context;Ljava/lang/String;I)V

    :cond_0
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    :cond_1
    sget p1, Lcom/miui/support/cardview/R$styleable;->O:I
    ...
    iput-boolean p1, p0, Lcom/miui/support/cardview/CardView;->q:Z
    ...
    :cond_2
    sget p1, Lcom/miui/support/cardview/R$styleable;->M:I
    ...
    sget p1, Lcom/miui/support/cardview/R$styleable;->J:I
    ...
    invoke-direct {p0}, Lcom/miui/support/cardview/CardView;->h()V
...
.method private e()Z
    ...
    invoke-direct {p0}, Lcom/miui/support/cardview/CardView;->f()Z

    move-result v0

    if-nez v0, :cond_0

    iget-boolean p0, p0, Lcom/miui/support/cardview/CardView;->q:Z
...
.method private g(Landroid/content/Context;Ljava/lang/String;I)V
    .locals 5
...
.method private setSmoothCornerEnable(Z)V
    ...
    invoke-static {v0, p0, v1, v3, v2}, Lmiuix/reflect/ReflectionHelper;->m(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)V
    :try_end_0
...
.method public getStrokeColor()I
    ...
    iget p0, p0, Lcom/miui/support/cardview/CardView;->p:I
...
.method public getStrokeWidth()I
    ...
    iget p0, p0, Lcom/miui/support/cardview/CardView;->o:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/miui/support/cardview/CardView;->s:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v0, p0, Lcom/miui/support/cardview/CardView;->r:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lcom/miui/support/cardview/CardView;->r:Landroid/graphics/RectF;
...
.method public setStrokeColor(I)V
    ...
    iget v0, p0, Lcom/miui/support/cardview/CardView;->p:I

    if-eq v0, p1, :cond_0

    iput p1, p0, Lcom/miui/support/cardview/CardView;->p:I
...
.method public setStrokeWidth(I)V
    ...
    iget v0, p0, Lcom/miui/support/cardview/CardView;->o:I

    if-eq v0, p1, :cond_0

    iput p1, p0, Lcom/miui/support/cardview/CardView;->o:I
