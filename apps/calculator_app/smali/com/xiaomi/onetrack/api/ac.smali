...
.method constructor <init>(Lcom/xiaomi/onetrack/api/h;Ljava/lang/String;Ljava/util/Map;)V
    ...
    iput-object p1, p0, Lcom/xiaomi/onetrack/api/ac;->h:Lcom/xiaomi/onetrack/api/h;

    iput-object p2, p0, Lcom/xiaomi/onetrack/api/ac;->f:Ljava/lang/String;

    iput-object p3, p0, Lcom/xiaomi/onetrack/api/ac;->g:Ljava/util/Map;
...
.method public run()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/onetrack/api/ac;->h:Lcom/xiaomi/onetrack/api/h;

    iget-object v1, p0, Lcom/xiaomi/onetrack/api/ac;->f:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lcom/xiaomi/onetrack/api/ac;->g:Ljava/util/Map;
    ...
    iget-object v2, p0, Lcom/xiaomi/onetrack/api/ac;->f:Ljava/lang/String;
    ...
    invoke-static/range {v2 .. v8}, Lcom/xiaomi/onetrack/api/c;->k(Ljava/lang/String;Lorg/json/JSONObject;Lcom/xiaomi/onetrack/Configuration;Lcom/xiaomi/onetrack/OneTrack$IEventHook;Lorg/json/JSONObject;Lcom/xiaomi/onetrack/util/v;Z)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/xiaomi/onetrack/api/ac;->h:Lcom/xiaomi/onetrack/api/h;

    invoke-static {v1}, Lcom/xiaomi/onetrack/api/h;->B(Lcom/xiaomi/onetrack/api/h;)Lcom/xiaomi/onetrack/api/e;

    move-result-object v1

    iget-object p0, p0, Lcom/xiaomi/onetrack/api/ac;->f:Ljava/lang/String;
