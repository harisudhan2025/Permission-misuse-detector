...
# instance fields
.field private a:Lcom/xiaomi/onetrack/Configuration;

.field private b:Lcom/xiaomi/onetrack/util/v;
...
.method public constructor <init>(Landroid/content/Context;Lcom/xiaomi/onetrack/Configuration;Lcom/xiaomi/onetrack/util/v;)V
    ...
    iput-object p2, p0, Lcom/xiaomi/onetrack/api/aj;->a:Lcom/xiaomi/onetrack/Configuration;

    iput-object p3, p0, Lcom/xiaomi/onetrack/api/aj;->b:Lcom/xiaomi/onetrack/util/v;
...
.method private a(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;Lorg/json/JSONObject;Z)V
    ...
    iget-object v1, p0, Lcom/xiaomi/onetrack/api/aj;->a:Lcom/xiaomi/onetrack/Configuration;

    invoke-virtual {v1}, Lcom/xiaomi/onetrack/Configuration;->c()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/xiaomi/onetrack/Configuration;->b()Ljava/lang/String;

    move-result-object v1

    :cond_0
    invoke-direct {p0, v1}, Lcom/xiaomi/onetrack/api/aj;->e(Ljava/lang/String;)Z
    ...
    invoke-static {v3, p0}, Lcom/xiaomi/onetrack/util/p;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v1, p1, v4, v0}, Lcom/xiaomi/onetrack/b/h;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v5}, Lcom/xiaomi/onetrack/util/p;->c(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v4, v2}, Lcom/xiaomi/onetrack/api/aj;->h(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_5

    invoke-direct {p0, v1, p1}, Lcom/xiaomi/onetrack/api/aj;->i(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_3
    invoke-direct {p0, v1, p1}, Lcom/xiaomi/onetrack/api/aj;->j(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v1}, Lcom/xiaomi/onetrack/b/h;->n(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v0, v4}, Lcom/xiaomi/onetrack/util/z;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/Set;

    move-result-object v0

    invoke-direct {p0, p3, v0}, Lcom/xiaomi/onetrack/api/aj;->d(Lorg/json/JSONObject;Ljava/util/Set;)V

    invoke-direct {p0, p4, v0}, Lcom/xiaomi/onetrack/api/aj;->d(Lorg/json/JSONObject;Ljava/util/Set;)V
    ...
    invoke-static {v3, p0}, Lcom/xiaomi/onetrack/util/p;->g(Ljava/lang/String;Ljava/lang/String;)V

    :goto_2
    return-void
.end method

.method private d(Lorg/json/JSONObject;Ljava/util/Set;)V
    .locals 2
...
.method private e(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, v0}, Lcom/xiaomi/onetrack/b/h;->h(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private i(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1, p2, v1, p0}, Lcom/xiaomi/onetrack/b/h;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {p2, p1}, Lcom/xiaomi/onetrack/util/p;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method private j(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/onetrack/b/h;->k(Ljava/lang/String;Ljava/lang/String;)J
    ...
    invoke-virtual {v1, v0}, Lcom/xiaomi/onetrack/util/oaid/a;->b(Landroid/content/Context;)Ljava/lang/String;
...
.method public b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v4}, Lcom/xiaomi/onetrack/util/p;->c(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :goto_2
    invoke-direct {p0, v8}, Lcom/xiaomi/onetrack/api/aj;->f(Lorg/json/JSONObject;)Z

    move-result v10

    iget-object v1, p0, Lcom/xiaomi/onetrack/api/aj;->b:Lcom/xiaomi/onetrack/util/v;

    if-eqz v1, :cond_0

    invoke-virtual {v1, p1}, Lcom/xiaomi/onetrack/util/v;->d(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/onetrack/api/aj;->g(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2}, Lcom/xiaomi/onetrack/c/i;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, p2}, Lcom/xiaomi/onetrack/util/p;->c(Ljava/lang/String;Ljava/lang/String;)V

    :cond_3
    if-eqz v10, :cond_4

    iget-object p2, p0, Lcom/xiaomi/onetrack/api/aj;->a:Lcom/xiaomi/onetrack/Configuration;

    invoke-virtual {p2}, Lcom/xiaomi/onetrack/Configuration;->b()Ljava/lang/String;

    move-result-object p2

    invoke-static {p2}, Lcom/xiaomi/onetrack/b/a;->d(Ljava/lang/String;)V

    :cond_4
    iget-object p2, p0, Lcom/xiaomi/onetrack/api/aj;->a:Lcom/xiaomi/onetrack/Configuration;

    invoke-virtual {p2}, Lcom/xiaomi/onetrack/Configuration;->c()Ljava/lang/String;
...
.method public g(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {}, Lcom/xiaomi/onetrack/OneTrack;->b()Z
    ...
    invoke-static {}, Lcom/xiaomi/onetrack/OneTrack;->c()Z
